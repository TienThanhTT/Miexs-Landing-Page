    ...
    return (
      <>
        ...
        >
          ...
          <button className="bg-[#3B52FF] text-white px-5 py-3 rounded-[29px] lg:block">Build on MIEXS</button>
          <button className="absolute top-[42px] right-[15px] lg:hidden block" onClick={() => this.openMenu()}>
            <FaBars size="24px" />
          </button>
        </header>
      </>
