            ...
            <div className="grid grid-cols-12 gap-[30px]">
              <div className="section2_left lg:col-span-8 col-span-12">
                ...
                <div className="text-[17px] mb-[66px]">
                  <p>
                    From next generation up starts solving real-world problems to big name infrastructure and service
                    providers, join our journey and build in the most promising blockchain ecosystem in existence.
                  </p>
                </div>
                <div className="">
