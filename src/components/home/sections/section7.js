            ...
            <div className="section7_wrapper">
                <div className="section7">
                    <div className="section7_left">
                        <div className="title section7-left_title">
                            Build on Miexs
                        </div>
                        <div className="section7-left_content">
                            The possibilities are endless with Miexs's payment solution ecosystem - 
                            join now and discoverhundreds of apps and services geared towards driving 
                    ...
                    <div className="section7-right_wrapper">
                        <div className="section7_right">
                            ...
                            <div className="section7-right_content">
                                ...
                                that offers EVM compatibility, cheap and fast transactions, and a 
                                high-performance user experience. Deploy your dApps on Miexs at a 
                                fraction of the cost of Ethereum and experience the benefits of a scalable 
                        ...
                        <div className="section7_right">
                            ...
                            <div className="section7-right_content">
                                Deploy smart contracts by utilizing Miexs RPC to interact with Miexs blockchain 
                                nodes and industry-leaders oracle providers Dia and Supra to access price feed. 
                                and efficient blockchain.
                            </div>
                                <div className="section7-right_arrowContent">
                                    <BlackArrowIcon/>
                        ...
                        <div className="section7_right">
                            ...
                            <div className="section7-right_content">
                                Miexs APIs allow you to Build Web3 apps as easily as traditional Web2 
                                applications with zero previous knowledge of crypto.
                            </div>
                                <div className="section7-right_arrowContent">
                                    <BlackArrowIcon/>
